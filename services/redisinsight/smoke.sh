# RedisInsight — this Module's smoke check.
#
...
#
# This is liveness, not function: / answers the same from a RedisInsight that
# started but never reached Redis. See gotchas.md. Upgrading it is a change of
# behaviour story 2-4 deliberately did not make.
#
